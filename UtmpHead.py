...
NEXT_POS = 0
HASHHEAD_POS = NEXT_POS + Utmp.Utmp.USHM_SIZE * 4
NUMBER_POS = HASHHEAD_POS + (Utmp.Utmp.UTMP_HASHSIZE + 1) * 4
LISTHEAD_POS = NUMBER_POS + 4
LISTPREV_POS = LISTHEAD_POS + 4
LISTNEXT_POS = LISTPREV_POS + 4 * Utmp.Utmp.USHM_SIZE
UPTIME_POS = LISTNEXT_POS + 4 * Utmp.Utmp.USHM_SIZE
